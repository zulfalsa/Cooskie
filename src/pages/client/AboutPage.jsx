  ...
  return (
    <div className="min-h-screen bg-white pb-12">
      <div className="relative h-64 md:h-80 bg-[#1e3a8a] flex items-center justify-center overflow-hidden">
        ...
        <img src="https://images.unsplash.com/photo-1556910103-1c02745a30bf?auto=format&fit=crop&w=1600&q=80" alt="Baking" className="absolute inset-0 w-full h-full object-cover opacity-60" />
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center mb-20">
          <div className="flex-1">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Berawal dari dapur kecil di tahun 2020, Cooskie (sebelumnya Veloura) didirikan dengan satu misi sederhana: menciptakan cookies yang tidak hanya enak, tetapi juga membawa kebahagiaan.
            </p>
          ...
          <div className="flex-1 relative">
            <img src="https://images.unsplash.com/photo-1600431562289-a5f5ced396d6?auto=format&fit=crop&w=800&q=80" className="rounded-2xl shadow-xl rotate-3 hover:rotate-0 transition-all duration-500" alt="Baker" />
          </div>
        </div>
