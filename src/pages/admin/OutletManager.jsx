...
import { Plus, Edit, Trash2, MapPin, X, Loader, Image as ImageIcon, Search } from 'lucide-react';
...
export default function OutletManager() {
  ...
  return (
    <div>
      ...
      {/* Tampilan Tabel untuk Konsistensi */}
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredOutlets.map(outlet => (
                <tr key={outlet.id} className="hover:bg-gray-50 transition-colors group">
                  <td className="p-4">
                  ...
                  <td className="p-4">
                    <div className="flex gap-2 items-start max-w-xs text-gray-600">
              ...
              {filteredOutlets.length === 0 && (
                <tr><td colSpan="5" className="p-8 text-center text-gray-400">Tidak ada outlet ditemukan.</td></tr>
              )}
            </tbody>
          </table>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl w-full max-w-lg p-6 shadow-2xl animate-fade-in">
            <div className="flex justify-between items-center mb-6 border-b border-gray-100 pb-4">
              ...
              <button onClick={() => setIsModalOpen(false)} className="p-2 hover:bg-gray-100 rounded-full"><X size={20} className="text-gray-400"/></button>
            </div>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="mb-4">
                 <label className="block text-sm font-medium text-gray-700 mb-1">Foto Outlet</label>
                 <input type="file" accept="image/*" className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" onChange={e => setFile(e.target.files[0])} />
              </div>
